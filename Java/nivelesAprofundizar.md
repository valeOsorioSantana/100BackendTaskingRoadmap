...
# Junior
Estudiante júnior (Desarrollador intermedio): Estudiante que ya puede aplicar a un trabajo. 

Puede trabajar de forma independiente en funcionalidades, comprender interacciones de bases de datos más complejas, fundamentos de seguridad, mensajería, principios de diseño de API y metodologías de pruebas. Comprende los fundamentos de la implementación.

Un desarrollador júnior ya no está en la etapa básica de solo seguir instrucciones o copiar código. En este punto, puede asumir funcionalidades completas de manera autónoma, como construir un módulo, una API o una interfaz sin depender constantemente de un líder técnico. Comprende cómo se conectan los distintos componentes del sistema (backend, frontend, base de datos), y ya tiene experiencia suficiente para leer requerimientos, analizar una necesidad del negocio y plantear una solución técnica viable con clases, métodos, estructuras de datos y diseño orientado a objetos.

Además, este perfil maneja conceptos clave como consultas SQL complejas, relaciones entre tablas, uso de ORMs, e incluso entiende cómo asegurar que los datos estén consistentes y protegidos. Tiene nociones sólidas sobre seguridad básica en aplicaciones (por ejemplo, evitar inyecciones SQL, cifrado de contraseñas o validación de entrada). También puede aplicar mensajería asincrónica (como Kafka o RabbitMQ en proyectos más grandes), y domina fundamentos como las pruebas unitarias, pruebas de integración y el uso de mocks para testear servicios. Maneja herramientas de versionamiento como Git con fluidez y participa activamente en procesos como pull requests o revisión de código.

En términos de arquitectura, comienza a comprender patrones como MVC, DAO, y principios SOLID, incluso si aún no los domina a profundidad. Tiene claro cómo consumir o diseñar APIs RESTful de forma lógica y eficiente, aplicando prácticas como versionado, uso adecuado de verbos HTTP, y diseño centrado en recursos. También ha empezado a trabajar bajo metodologías ágiles como Scrum o Kanban, y puede estimar tareas, participar en dailies y aportar a la planificación. En resumen, ya es un jugador confiable en el equipo, que puede desarrollar con autonomía y contribuir al flujo de desarrollo real de un producto.
